...
public class UserMappingImpl implements UserMapping {
    ...
    public User dtoToEntity(UserDTO user) {
        ...
        user1.setTicketsAssignedToMe( ticketDTOListToTicketSet( user.getTicketsAssignedToMe() ) );
    ...
    protected DepartmentDTO departmentToDepartmentDTO(Department department, CycleAvoidingMappingContext context) {
        ...
        departmentDTO.setCreatedBy( entityToDTO( department.getCreatedBy(), context ) );
    ...
    protected CategoryDTO categoryToCategoryDTO(Category category, CycleAvoidingMappingContext context) {
        ...
        categoryDTO.setCreatedBy( entityToDTO( category.getCreatedBy(), context ) );
    ...
    protected TicketDTO ticketToTicketDTO(Ticket ticket, CycleAvoidingMappingContext context) {
        ...
        assignedTo = entityToDTO( ticket.getAssignedTo(), context );
        ...
        createdBy = entityToDTO( ticket.getCreatedBy(), context );
    ...
    protected Department departmentDTOToDepartment(DepartmentDTO departmentDTO) {
        ...
        department.setCreatedBy( dtoToEntity( departmentDTO.getCreatedBy() ) );
    ...
    protected Category categoryDTOToCategory(CategoryDTO categoryDTO) {
        ...
        category.setCreatedBy( dtoToEntity( categoryDTO.getCreatedBy() ) );
    ...
    protected Ticket ticketDTOToTicket(TicketDTO ticketDTO) {
        ...
        ticket.setCreatedBy( dtoToEntity( ticketDTO.createdBy() ) );
        ...
        ticket.setAssignedTo( dtoToEntity( ticketDTO.assignedTo() ) );
