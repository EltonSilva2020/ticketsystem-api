...
import be.ticketsystem.api.repository.TicketRepository;
import be.ticketsystem.api.repository.UserRepository;
...
public class TicketSystemApiApplication {
    ...
    private void exec(String[] args) {
        ...
        User user = new User();
        user.setEmail(System.currentTimeMillis() + "-elton@email.com");
